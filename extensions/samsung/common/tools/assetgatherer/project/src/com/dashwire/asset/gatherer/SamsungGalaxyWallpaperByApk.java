...
public class SamsungGalaxyWallpaperByApk extends AssetGatherer {
    private static final String TAG = SamsungGalaxyWallpaperByApk.class.getCanonicalName();

	private String apk;
	private String filter;
	private String uri_base;
	public SamsungGalaxyWallpaperByApk(JSONObject config, File outputDir)
	{
	...
	protected JSONArray getAssets(Context context) {
        ...
        try {
            ...
            while ( e.hasMoreElements() ) {
                ...
                if ( ( ( entry.getName().contains( "drawable-xhdpi" ) || entry.getName().contains( "drawable-hdpi" ) ) && entry.getName().contains( filter ) ) ) {
