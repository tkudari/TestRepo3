...
public class DeviceConstants {
    ...
    public static final String TWLAUNCHER_COMP = "com.sec.android.app.twlauncher";
    public static final String FAVORITES_URI = "content://com.sec.android.app.twlauncher.settings/favorites";
    ...
    public static final String EMAIL_CONFIG_COMPONENT_URI = "com.dashwire.config";
}
