...
public class NanoHTTPD {
    ...
    {
        Log.d(TAG, "NanoHTTPD 1.25 (C) 2001,2005-2011 Jarno Elonen and (C) 2010 Konstantinos Togias\n" +
        ...
        Log.d(TAG, "Now serving files in port " + port + " from \"" + wwwroot + "\"" );
        Log.d(TAG, "Hit Enter to stop.\n" );
