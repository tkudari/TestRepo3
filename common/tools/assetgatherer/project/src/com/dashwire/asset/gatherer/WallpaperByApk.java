...
public class WallpaperByApk extends AssetGatherer {
    private static final String TAG = WallpaperByApk.class.getCanonicalName();
	private String apk;
	private String filter;
	private String uri_base;
	public WallpaperByApk(JSONObject config,File outputDir)
	{
	...
	protected JSONArray getAssets(Context context) {
        ...
        try {
            ...
            while ( e.hasMoreElements() ) {
                ...
                if ( ( entry.getName().contains( "drawable" ) && entry.getName().contains( filter ) ) ) {
                    ...
                    if ( (entryFileName.toLowerCase().startsWith( "wallpaper_" ) ||  entryFileName.toLowerCase().startsWith( "wvga_" ) || entryFileName.contains( "celox_" )) &&
