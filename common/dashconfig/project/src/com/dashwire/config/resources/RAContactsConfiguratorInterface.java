...
public class RAContactsConfiguratorInterface implements ResourceConfigurator
{

	private static final String TAG = RAContactsConfiguratorInterface.class.getCanonicalName();
	...
	public RAContactsConfiguratorInterface()
	{
	}
	...
	public void configure() {
		...
		if (mConfigArray != null && mConfigArray.length() > 0)
		{
			...
			try
			{
				Log.v(TAG,"Inside RAContactsConfiguratorInterface configure()");
				...
				featureConfigurationRequestIntent.putExtra("featureName", "Contacts");
