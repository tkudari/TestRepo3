...
public class SetupWizardActivity extends BaseStartActivity {
    
	private static final String TAG = SetupWizardActivity.class.getCanonicalName();
    public void onCreate( Bundle savedInstanceState ) {
        super.onCreate( savedInstanceState );
        Tracker.track(context, "setupWizard");
        
        Button cancelButton = ( Button ) findViewById( R.id.cancel_button );
        if ( cancelButton != null ) {
            cancelButton.setOnClickListener( new OnClickListener() {
                public void onClick( View view ) {
                    Tracker.track(context, "setupWizard/cancel");
    ...
    void setLauncherFlag() {
        ...
        CommonUtils.setLaunchFromIndicator( CommonConstants.LAUNCH_FROM_SETUP_WIZARD_IND, context );
    }
}
